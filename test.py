...
data = bytes('test', encoding="utf-8") # Must be a bytes object

# key = b'Sixteen byte key' # The key you generated

# # Create cipher object and encrypt the data
# cipher = AES.new(key, AES.MODE_CBC) # Create a AES cipher object with the key using the mode CBC
# ciphered_data = cipher.encrypt(pad(data, AES.block_size)) # Pad the input data and then encrypt
# print(ciphered_data.hex())
...
# cipher = AES.new(key, AES.MODE_CBC) # Create a AES cipher object with the key using the mode CBC
# dec = cipher.decrypt(ciphered_data)
# print(dec)
...
s = "asdasdasdasdasdasdasdasdasdasdas" # 32 characters
key = s.encode("utf-8")
keyB64 = base64.b64encode(key)
fernet = Fernet(keyB64)
encMessage = fernet.encrypt(bytes(data, encoding='utf-8'))


encString = encMessage.decode("utf-8")
print(encString)

# secret = lsb.hide('./1.jpg', "test")
# secret.save("./test.jpg")

# clear_message = lsb.reveal("./test.jpg")
# print(clear_message)




decrypted = fernet.decrypt(encString.encode("utf-8"))
